...
function login()
{
    ...
    {
        // Пользователь получает форму входа:
    ...
    {
        // Пользователь еще не получил форму:
        // выводим форму
        require (TEMPLATE_PATH . "/admin/loginForm.php");
    }
}
...
function newArticle()
{
    ...
    {
        // Пользователь получает форму
        // редактирования статьи: сохраняет новую статью
        $article = new Article;
    ...
    {
        // Пользователь сбросил результаты
        // редактирования: возвращаемся к списку статей
        header("Location: admin.php" );
    }
    else
    {
...
function editArticle()
{
    ...
    if ( isset( $_POST['saveChanges'] ) )
    {
        // Пользователь получил форму редактирования статьи:
        // сохраняем изменения
...
function listCategories() {
    ...
    if ( isset( $_GET['error'] ) ) {
        ...
        if ( $_GET['error'] == "categoryContainsArticles" ) 
            ...
            Delete the articles, or assign them to another category, before deleting this category.";
    }
...
function newCategory() {
    ...
    if ( isset( $_POST['saveChanges'] ) ) {
        ...
        // Пользователь  добавляет категорию: сохраняем
        ...
        // Пользователь отменяет ввод данных: возврат к списку категории
        header( "Location: admin.php?action=listCategories" );
    } else {

        // Пользователь не создалд новую категорию: возврат на форму редактирования
